...
export class TodosController {
  ...
  async create({ body }: MayaJsContext): Promise<IRouteRequest> {
    ...
    return { message: "Successfully added a todo.", data };
  }
  ...
  async getById({ params }: MayaJsContext): Promise<IRouteRequest> {
    const data = {};
    return { message: "Successfully get a todo by id.", data };
  }

  @Put("/:id")
  async replace({ body, params }: MayaJsContext): Promise<IRouteRequest> {
    const data = {};
    return { message: "Successfully replaced a todo by id.", data };
  }

  @Patch("/:id")
  async update({ body, params }: MayaJsContext): Promise<IRouteRequest> {
    const data = {};
    return { message: "Successfully updated a todo by id.", data };
  }

  @Delete("/:id")
  async delete({ params }: MayaJsContext): Promise<IRouteRequest> {
    const data = {};
    return { message: "Successfully deleted a todo by id.", data };
  }
}
